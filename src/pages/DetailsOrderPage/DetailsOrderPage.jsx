...
const DetailsOrderPage = () => {
  ...
  return (
   <Loading isLoading={isLoading}>
     <div style={{width: '100%', height: '100vh', marginTop: "140px", fontFamily: "poppins, sans-serif"}}>
      <div style={{ width: '1270px', margin: '0 auto', height: '1270px'}}>
        <h4 style={{marginBottom: "16px"}}>Chi tiết đơn hàng</h4>
        <WrapperHeaderUser>
          <WrapperInfoUser>
          ...
          <WrapperInfoUser>
            ...
            <WrapperContentInfo>
              ...
              <div className='delivery-fee'><span>Phí giao hàng: </span> {data?.ShippingFee}</div>
            </WrapperContentInfo>
          </WrapperInfoUser>
          <WrapperInfoUser>
        ...
        <WrapperStyleContent>
          <div style={{flex:1,display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
            <div style={{width: '670px', marginLeft: "10px"}}>Sản phẩm</div>
          ...
          <WrapperAllPrice>
            ...
            <WrapperItem>{convertPrice(data?.ShippingFee)}</WrapperItem>
          </WrapperAllPrice>
          <WrapperAllPrice>
